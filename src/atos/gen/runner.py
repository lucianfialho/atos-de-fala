"""The generation loop (concurrent waves, balancing, adjudication). Kept separate from
the argparse layer in cli.py so each file stays focused and under the size gate."""
import sys
