...
`atos.train.eval_cli` consumes. Follow `config/rubric.md` while annotating —
...
from atos.gold_score import score_against  # re-exported for back-compat (atos.gold.score_against)
